...
class res_partner(models.Model):
    ...
    relative_partner_id = fields.Many2one('res.partner',string="Id relativo")
    ...
    company_insurance_ids = fields.One2many('medical.insurance','insurance_compnay_id','Seguros')
    reference = fields.Char('ID No.')
